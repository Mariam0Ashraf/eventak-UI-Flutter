...
class _SearchViewState extends State<SearchView> {
  ...
  int? _selectedAreaId; // sent to API as area_id
  ...
  String _query = '';
  String? _type; // service/package/null (UI only; API might not support it)
  ...
  void _onSearchChanged() {
    ...
    _debounce = Timer(const Duration(milliseconds: 400), () {
      ...
      // search only if typed something OR filters are already applied
      _performSearch();
    });
  }
  ...
  Future<void> _performSearch() async {
    ...
    try {
      ...
      setState(() {
        ...
        // if API doesn't support type, we filter locally in UI

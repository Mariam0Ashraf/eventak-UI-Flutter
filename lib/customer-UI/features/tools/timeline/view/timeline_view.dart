import 'package:eventak/customer-UI/features/tools/timeline/widgets/create_timeline_dialog.dart';
...
class TimelineView extends StatefulWidget {
  ...
  const TimelineView({super.key, required this.eventId, required this.eventTitle});
...
class _TimelineViewState extends State<TimelineView> {
  ...
  try {
                ...
                pw.Align(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        'Total Duration: ${data['summary']['total_duration_minutes']} minutes (${data['summary']['total_duration_hours']} hours)',
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Failed to generate PDF view')),
      );
    }
  }
}

...
class _WebsiteFormDialogState extends State<WebsiteFormDialog> {
  ...
  late TextEditingController _slug, _font, _mTitle, _mDesc, _welcomeMsg;
  ...
  void initState() {
    ...
    _font = TextEditingController(text: w?.design.fontFamily ?? "");
    ...
    return FutureBuilder<Map<String, String>>(
      ...
      builder: (context, snapshot) {
        ...
        return DropdownButtonFormField<String>(
          value: templates.containsKey(_selectedTemplate) ? _selectedTemplate : null,
          items: templates.entries.map((e) => DropdownMenuItem(value: e.key, child: Text(e.value))).toList(),
